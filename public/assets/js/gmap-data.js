...
if( $('#map_canvas').length > 0 ){	
	 // When the window has finished loading create our google map below
		...
		function init() {
			...
			'<h5 class="infowindow-header">Everlast Pvt Ltd</h5>'+
			'<div class="infowindow-body"><p class="txt-dark mb-15">121 King Street, <br>Melbourne VIC 3000, Australia</p><a href="https://EverlastEnergy.com/" target="_blank">www.EverlastEnergy.com</a></div>'+
			'</div>';
