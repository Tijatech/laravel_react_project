            ...
            <div className="col-xl-12 pa-0">
              <div className="auth-form-wrap pt-xl-0 pt-70">
                <div className="auth-form w-xl-30 w-lg-55 w-sm-75 w-100">
                  ...
                  <h3 style={{color: '#18a809', textAlign: 'center', marginBottom: '40px'}}>TPV Portal Login</h3>
                  ...
                  <form onSubmit={this.handleSubmit}>
                    <div className="form-group">
                      <input className="form-control" name="email" placeholder="Username" type="text" onChange={this.handleEmail} />
                    </div>
                    <div className="form-group">
                    ...
                    <p className="font-14 text-center mt-15"><Link to="/team_login">Team Member</Link> or <Link to="/tpv_login">TPV Agent</Link>?  Login <Link to="/">here</Link>.</p>
                           <p class="font-14 text-center mt-15"><a href="ResetPasswordEmailPage.php?tpv=1">Forget Password</a></p>
                  </form>
                </div>
              </div>
            </div>
